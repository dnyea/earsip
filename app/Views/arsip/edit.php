    ...
    <div class="box box-primary box-solid">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="nama_arsip" id="nama_arsip" class="form-control" placeholder="Nama Arsip" required value="<?= $arsip['nama_arsip']; ?>">
        </div>
        <div class="form-group">
          <label for="no_arsip">Nomer Arsip</label>
          <input type="text" value="<?= $arsip['no_arsip']; ?>" name="no_arsip" id="no_arsip" class="form-control" readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="deskrepsi" id="deskrepsi" class="form-control" placeholder="Deskrepsi" required value="<?= $arsip['deskrepsi'] ?>">
        </div>
        <div class=" form-group">
          <label for="file_arsip">Ganti File Arsip</label>
