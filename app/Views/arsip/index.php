    ...
    <div class="box box-primary box-solid">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
          <a href="<?= base_url('arsip/add')  ?>" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>Tambah ARSIP</a>
        </div>
        <!-- /.box-tools -->
      </div>
      <!-- /.box-header -->
              ...
              <tr>
                ...
                <td>
                  <a href="<?= base_url('arsip/viewpdf/' . $value['id_arsip']); ?>">
                    <i class="fa fa-file-pdf-o fa-2x label-danger"></i></a>
                  <br>
                  <?= number_format($value['ukuran_file'], 0)  ?> KB
                </td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Hapus Data Arsip</h4>
        </div>
        <div class="modal-body">
          Apakah Anda Ingin Menghapus Data <b> <?= $value['nama_arsip'] ?> </b>?
        </div>
